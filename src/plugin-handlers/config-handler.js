...
var plugin_config_js_1 = require("../plugin-config.js");
        ...
        handle: function (config) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    pluginConfig = config['my-opencode-plugin'] || {};
                    return [2 /*return*/, (0, plugin_config_js_1.mergeConfigs)(config, pluginConfig)];
                });
            });
        },
    };
