...
**Merge: bash + existing + explore findings. Mark "discovery" as completed.**
...
## CODE MAP
{From explore agents - skip if unavailable or project <10 files}
...
Launch explore agents for each location:
